...
UI = {
 'en': dict(
    ...
    intro='For oily skin that gets the occasional pimple, on a night-shift schedule. Prices and availability were checked on 11 September 2026 at Watsons Philippines and brand stores; they change often, so treat them as a guide.',
    ...
    notes=['Prices and stock: Watsons Philippines product listings on 11 September 2026; a few earlier 2026 sale prices are noted where seen. Mercury Drug carries the mass-market brands listed (CeraVe, Senka, Bioré, Neutrogena, Vaseline) in most branches; St. Joseph Drug stocks a narrower range, so check your branch.',
           'Ingredient lists come from the retailer or brand listings (Watsons PH, La Roche-Posay, DHC) and, for the Filipino brands, from the SkinSort ingredient database.',
 ...
 'tl': dict(
    ...
    intro='Para sa oily na balat na paminsan-minsang tinutubuan ng pimple, at para sa night-shift na iskedyul. Na-check ang mga presyo at availability noong 11 Setyembre 2026 sa Watsons Philippines at sa mga official store ng brand; madalas itong magbago, kaya gawing gabay lang.',
    ...
    notes=['Presyo at stock: mga listing ng Watsons Philippines noong 11 Setyembre 2026; nakatala ang ilang sale price mula nang mas maaga sa 2026 kung nakita. May mga mass-market brand ang Mercury Drug (CeraVe, Senka, Bioré, Neutrogena, Vaseline) sa karamihan ng branch; mas limitado ang St. Joseph Drug, kaya i-check ang branch mo.',
           'Ang mga listahan ng sangkap ay mula sa mga listing ng retailer o brand (Watsons PH, La Roche-Posay, DHC) at, para sa mga Filipino brand, mula sa ingredient database ng SkinSort.',
...
WAKE = [
 ...
 dict(key='serum', products=['dermorepubliq', 'ordinary', 'anua', 'melanocc'],
      ...
      amount={'en': '2–3 drops, about half a dropper. For Melano CC, a pea for the whole face or just a dab on pimple-prone areas.', 'tl': '2–3 patak, mga kalahating dropper. Para sa Melano CC, kasinlaki ng gisantes para sa buong mukha o i-dab lang sa bahaging madalas tubuan ng pimple.'},
...
GLOSSARY = [
 ...
 ({'en': 'Oil, pores and pimple helpers', 'tl': 'Para sa langis, pores at pimples'}, [
   ...
   G({'en': 'Tea tree leaf oil', 'tl': 'Tea tree leaf oil'},
     'A plant oil with proven activity against acne bacteria, and the source of the COSRX cleanser’s scent. Good for pimple-prone skin, though a few people are sensitive to it.',
     'Langis ng halaman na napatunayang tumatalab laban sa acne bacteria, at ito ang pinagmumulan ng amoy ng COSRX cleanser. Mainam para sa pimple-prone na balat, bagama’t may ilang sensitive dito.',
     ['cosrx']),
 ...
 ({'en': 'Brighteners and antioxidants', 'tl': 'Pampaliwanag at antioxidant'}, [
   ...
   G({'en': 'Vitamin C (ascorbic acid, 3-O-ethyl ascorbic acid, ascorbyl tetraisopalmitate)', 'tl': 'Vitamin C (ascorbic acid, 3-O-ethyl ascorbic acid, ascorbyl tetraisopalmitate)'},
     'An antioxidant that brightens and helps fade the red-brown marks pimples leave. Pure ascorbic acid (Melano CC) is the most active but can tingle; the derivatives in Anua and Hada Labo are gentler and slower.',
     'Antioxidant na nagpapaliwanag at tumutulong kumupas ang pula-kayumangging marka na iniiwan ng pimple. Ang purong ascorbic acid (Melano CC) ang pinakaaktibo pero puwedeng kumiliti; mas mabini at mas mabagal ang mga derivative sa Anua at Hada Labo.',
 ...
 ({'en': 'Worth knowing', 'tl': 'Dapat malaman'}, [
   G({'en': 'Alcohol (ethanol)', 'tl': 'Alcohol (ethanol)'},
     'Makes sunscreens and serums feel weightless and dry fast, a plus for oily skin, but it can sting broken or freshly-irritated skin. It is why Bioré and Melano CC feel so light.',
     'Nagpaparamdam ng gaan at mabilis na pagkatuyo sa sunscreen at serum, plus para sa oily na balat, pero puwedeng humapdi sa may sugat o bagong-iritang balat. Ito ang dahilan kung bakit napakagaan ng Bioré at Melano CC.',
